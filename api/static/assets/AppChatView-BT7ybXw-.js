import{u as he,$ as ae,b as ve,B as A,s as H,c as N,a as d,o as c,r as x,d as k,e as y,m,t as z,n as P,f as U,g as oe,h as w,i as ye,j as $e,k as E,l as B,p as we,q as X,v as Ce,w as xe,x as ke,y as R,R as Se,z as ze,A as Le,C as Ee,D as De,E as Pe,Z as _,F as Be,G as re,H as Y,I as Oe,J as D,K as $,T as Me,L as Fe,M as j,N as Ie,O as je,P as S,Q as Te,S as Ue,U as L,V as Ae,W as Ve,X as K,Y as ie,_ as _e,a0 as He,a1 as Ne,a2 as Re,a3 as G}from"./index-D4mursFM.js";function W(){ve({variableName:ae("scrollbar.width").name})}function q(){he({variableName:ae("scrollbar.width").name})}var Ke=({dt:e})=>`
.p-avatar {
    display: inline-flex;
    align-items: center;
...
`,dt={mask:function(t){var n=t.position,a=t.modal;return{position:"fixed",height:"100%",width:"100%",left:0,top:0,display:"flex",justifyContent:n==="left"||n==="topleft"||n==="bottomleft"?"flex-start":n==="right"||n==="topright"||n==="bottomright"?"flex-end":"center",alignItems:n==="top"||n==="topleft"||n==="topright"?"flex-start":n==="bottom"||n==="bottomleft"||n==="bottomright"?"flex-end":"center",pointerEvents:a?"auto":"none"}},root:{display:"flex",flexDirection:"column",pointerEvents:"auto"}},pt={mask:function(t){var n=t.props,a=["left","right","top","topleft","topright","bottom","bottomleft","bottomright"],r=a.find(function(o){return o===n.position});return["p-dialog-mask",{"p-overlay-mask p-overlay-mask-enter":n.modal},r?"p-dialog-".concat(r):""]},root:function(t){var n=t.props,a=t.instance;return["p-dialog p-component",{"p-dialog-maximized":n.maximizable&&a.maximized}]},header:"p-dialog-header",title:"p-dialog-title",headerActions:"p-dialog-header-actions",pcMaximizeButton:"p-dialog-maximize-button",pcCloseButton:"p-dialog-close-button",content:"p-dialog-content",footer:"p-dialog-footer"},mt=A.extend({name:"dialog",style:ct,classes:pt,inlineStyles:dt}),ft={name:"BaseDialog",extends:H,props:{header:{type:null,default:null},footer:{type:null,default:null},visible:{type:Boolean,default:!1},modal:{type:Boolean,default:null},contentStyle:{type:null,default:null},contentClass:{type:String,default:null},contentProps:{type:null,default:null},maximizable:{type:Boolean,default:!1},dismissableMask:{type:Boolean,default:!1},closable:{type:Boolean,default:!0},closeOnEscape:{type:Boolean,default:!0},showHeader:{type:Boolean,default:!0},blockScroll:{type:Boolean,default:!1},baseZIndex:{type:Number,default:0},autoZIndex:{type:Boolean,default:!0},position:{type:String,default:"center"},breakpoints:{type:Object,default:null},draggable:{type:Boolean,default:!0},keepInViewport:{type:Boolean,default:!0},minX:{type:Number,default:0},minY:{type:Number,default:0},appendTo:{type:[String,Object],default:"body"},closeIcon:{type:String,default:void 0},maximizeIcon:{type:String,default:void 0},minimizeIcon:{type:String,default:void 0},closeButtonProps:{type:Object,default:function(){return{severity:"secondary",text:!0,rounded:!0}}},maximizeButtonProps:{type:Object,default:function(){return{severity:"secondary",text:!0,rounded:!0}}},_instance:null},style:mt,provide:function(){return{$pcDialog:this,$parentInstance:this}}},ce={name:"Dialog",extends:ft,inheritAttrs:!1,emits:["update:visible","show","hide","after-hide","maximize","unmaximize","dragstart","dragend"],provide:function(){var t=this;return{dialogRef:re(function(){return t._instance})}},data:function(){return{containerVisible:this.visible,maximized:!1,focusableMax:null,focusableClose:null,target:null}},documentKeydownListener:null,container:null,mask:null,content:null,headerContainer:null,footerContainer:null,maximizableButton:null,closeButton:null,styleElement:null,dragging:null,documentDragListener:null,documentDragEndListener:null,lastPageX:null,lastPageY:null,maskMouseDownTarget:null,updated:function(){this.visible&&(this.containerVisible=this.visible)},beforeUnmount:function(){this.unbindDocumentState(),this.unbindGlobalListeners(),this.destroyStyle(),this.mask&&this.autoZIndex&&_.clear(this.mask),this.container=null,this.mask=null},mounted:function(){this.breakpoints&&this.createStyle()},methods:{close:function(){this.$emit("update:visible",!1)},onEnter:function(){this.$emit("show"),this.target=document.activeElement,this.enableDocumentSettings(),this.bindGlobalListeners(),this.autoZIndex&&_.set("modal",this.mask,this.baseZIndex+this.$primevue.config.zIndex.modal)},onAfterEnter:function(){this.focus()},onBeforeLeave:function(){this.modal&&!this.isUnstyled&&Be(this.mask,"p-overlay-mask-leave"),this.dragging&&this.documentDragEndListener&&this.documentDragEndListener()},onLeave:function(){this.$emit("hide"),E(this.target),this.target=null,this.focusableClose=null,this.focusableMax=null},onAfterLeave:function(){this.autoZIndex&&_.clear(this.mask),this.containerVisible=!1,this.unbindDocumentState(),this.unbindGlobalListeners(),this.$emit("after-hide")},onMaskMouseDown:function(t){this.maskMouseDownTarget=t.target},onMaskMouseUp:function(){this.dismissableMask&&this.modal&&this.mask===this.maskMouseDownTarget&&this.close()},focus:function(){var t=function(r){return r&&r.querySelector("[autofocus]")},n=this.$slots.footer&&t(this.footerContainer);n||(n=this.$slots.header&&t(this.headerContainer),n||(n=this.$slots.default&&t(this.content),n||(this.maximizable?(this.focusableMax=!0,n=this.maximizableButton):(this.focusableClose=!0,n=this.closeButton)))),n&&E(n,{focusVisible:!0})},maximize:function(t){this.maximized?(this.maximized=!1,this.$emit("unmaximize",t)):(this.maximized=!0,this.$emit("maximize",t)),this.modal||(this.maximized?W():q())},enableDocumentSettings:function(){(this.modal||!this.modal&&this.blockScroll||this.maximizable&&this.maximized)&&W()},unbindDocumentState:function(){(this.modal||!this.modal&&this.blockScroll||this.maximizable&&this.maximized)&&q()},onKeyDown:function(t){t.code==="Escape"&&this.closeOnEscape&&this.close()},bindDocumentKeyDownListener:function(){this.documentKeydownListener||(this.documentKeydownListener=this.onKeyDown.bind(this),window.document.addEventListener("keydown",this.documentKeydownListener))},unbindDocumentKeyDownListener:function(){this.documentKeydownListener&&(window.document.removeEventListener("keydown",this.documentKeydownListener),this.documentKeydownListener=null)},containerRef:function(t){this.container=t},maskRef:function(t){this.mask=t},contentRef:function(t){this.content=t},headerContainerRef:function(t){this.headerContainer=t},footerContainerRef:function(t){this.footerContainer=t},maximizableRef:function(t){this.maximizableButton=t?t.$el:void 0},closeButtonRef:function(t){this.closeButton=t?t.$el:void 0},createStyle:function(){if(!this.styleElement&&!this.isUnstyled){var t;this.styleElement=document.createElement("style"),this.styleElement.type="text/css",Pe(this.styleElement,"nonce",(t=this.$primevue)===null||t===void 0||(t=t.config)===null||t===void 0||(t=t.csp)===null||t===void 0?void 0:t.nonce),document.head.appendChild(this.styleElement);var n="";for(var a in this.breakpoints)n+=`
                    ...
                    `);this.styleElement.innerHTML=n}},destroyStyle:function(){this.styleElement&&(document.head.removeChild(this.styleElement),this.styleElement=null)},initDrag:function(t){t.target.closest("div").getAttribute("data-pc-section")!=="headeractions"&&this.draggable&&(this.dragging=!0,this.lastPageX=t.pageX,this.lastPageY=t.pageY,this.container.style.margin="0",document.body.setAttribute("data-p-unselectable-text","true"),!this.isUnstyled&&De(document.body,{"user-select":"none"}),this.$emit("dragstart",t))},bindGlobalListeners:function(){this.draggable&&(this.bindDocumentDragListener(),this.bindDocumentDragEndListener()),this.closeOnEscape&&this.closable&&this.bindDocumentKeyDownListener()},unbindGlobalListeners:function(){this.unbindDocumentDragListener(),this.unbindDocumentDragEndListener(),this.unbindDocumentKeyDownListener()},bindDocumentDragListener:function(){var t=this;this.documentDragListener=function(n){if(t.dragging){var a=ze(t.container),r=Le(t.container),o=n.pageX-t.lastPageX,l=n.pageY-t.lastPageY,s=t.container.getBoundingClientRect(),i=s.left+o,u=s.top+l,p=Ee(),f=getComputedStyle(t.container),h=parseFloat(f.marginLeft),C=parseFloat(f.marginTop);t.container.style.position="fixed",t.keepInViewport?(i>=t.minX&&i+a<p.width&&(t.lastPageX=n.pageX,t.container.style.left=i-h+"px"),u>=t.minY&&u+r<p.height&&(t.lastPageY=n.pageY,t.container.style.top=u-C+"px")):(t.lastPageX=n.pageX,t.container.style.left=i-h+"px",t.lastPageY=n.pageY,t.container.style.top=u-C+"px")}},window.document.addEventListener("mousemove",this.documentDragListener)},unbindDocumentDragListener:function(){this.documentDragListener&&(window.document.removeEventListener("mousemove",this.documentDragListener),this.documentDragListener=null)},bindDocumentDragEndListener:function(){var t=this;this.documentDragEndListener=function(n){t.dragging&&(t.dragging=!1,document.body.removeAttribute("data-p-unselectable-text"),!t.isUnstyled&&(document.body.style["user-select"]=""),t.$emit("dragend",n))},window.document.addEventListener("mouseup",this.documentDragEndListener)},unbindDocumentDragEndListener:function(){this.documentDragEndListener&&(window.document.removeEventListener("mouseup",this.documentDragEndListener),this.documentDragEndListener=null)}},computed:{maximizeIconComponent:function(){return this.maximized?this.minimizeIcon?"span":"WindowMinimizeIcon":this.maximizeIcon?"span":"WindowMaximizeIcon"},ariaLabelledById:function(){return this.header!=null||this.$attrs["aria-labelledby"]!==null?this.$id+"_header":null},closeAriaLabel:function(){return this.$primevue.config.locale.aria?this.$primevue.config.locale.aria.close:void 0},dataP:function(){return N({maximized:this.maximized,modal:this.modal})}},directives:{ripple:Se,focustrap:ut},components:{Button:R,Portal:ke,WindowMinimizeIcon:ue,WindowMaximizeIcon:le,TimesIcon:xe}};function F(e){"@babel/helpers - typeof";return F=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},F(e)}function te(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);t&&(a=a.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable})),n.push.apply(n,a)}return n}function ne(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?te(Object(n),!0).forEach(function(a){gt(e,a,n[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):te(Object(n)).forEach(function(a){Object.defineProperty(e,a,Object.getOwnPropertyDescriptor(n,a))})}return e}function gt(e,t,n){return(t=bt(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function bt(e){var t=ht(e,"string");return F(t)=="symbol"?t:t+""}function ht(e,t){if(F(e)!="object"||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var a=n.call(e,t);if(F(a)!="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}var vt=["data-p"],yt=["aria-labelledby","aria-modal","data-p"],$t=["id"],wt=["data-p"];function Ct(e,t,n,a,r,o){var l=Y("Button"),s=Y("Portal"),i=Oe("focustrap");return c(),k(s,{appendTo:e.appendTo},{default:D(function(){return[r.containerVisible?(c(),d("div",m({key:0,ref:o.maskRef,class:e.cx("mask"),style:e.sx("mask",!0,{position:e.position,modal:e.modal}),onMousedown:t[1]||(t[1]=function(){return o.onMaskMouseDown&&o.onMaskMouseDown.apply(o,arguments)}),onMouseup:t[2]||(t[2]=function(){return o.onMaskMouseUp&&o.onMaskMouseUp.apply(o,arguments)}),"data-p":o.dataP},e.ptm("mask")),[$(Me,m({name:"p-dialog",onEnter:o.onEnter,onAfterEnter:o.onAfterEnter,onBeforeLeave:o.onBeforeLeave,onLeave:o.onLeave,onAfterLeave:o.onAfterLeave,appear:""},e.ptm("transition")),{default:D(function(){return[e.visible?Fe((c(),d("div",m({key:0,ref:o.containerRef,class:e.cx("root"),style:e.sx("root"),role:"dialog","aria-labelledby":o.ariaLabelledById,"aria-modal":e.modal,"data-p":o.dataP},e.ptmi("root")),[e.$slots.container?x(e.$slots,"container",{key:0,closeCallback:o.close,maximizeCallback:function(p){return o.maximize(p)}}):(c(),d(j,{key:1},[e.showHeader?(c(),d("div",m({key:0,ref:o.headerContainerRef,class:e.cx("header"),onMousedown:t[0]||(t[0]=function(){return o.initDrag&&o.initDrag.apply(o,arguments)})},e.ptm("header")),[x(e.$slots,"header",{class:P(e.cx("title"))},function(){return[e.header?(c(),d("span",m({key:0,id:o.ariaLabelledById,class:e.cx("title")},e.ptm("title")),z(e.header),17,$t)):y("",!0)]}),w("div",m({class:e.cx("headerActions")},e.ptm("headerActions")),[e.maximizable?x(e.$slots,"maximizebutton",{key:0,maximized:r.maximized,maximizeCallback:function(p){return o.maximize(p)}},function(){return[$(l,m({ref:o.maximizableRef,autofocus:r.focusableMax,class:e.cx("pcMaximizeButton"),onClick:o.maximize,tabindex:e.maximizable?"0":"-1",unstyled:e.unstyled},e.maximizeButtonProps,{pt:e.ptm("pcMaximizeButton"),"data-pc-group-section":"headericon"}),{icon:D(function(u){return[x(e.$slots,"maximizeicon",{maximized:r.maximized},function(){return[(c(),k(U(o.maximizeIconComponent),m({class:[u.class,r.maximized?e.minimizeIcon:e.maximizeIcon]},e.ptm("pcMaximizeButton").icon),null,16,["class"]))]})]}),_:3},16,["autofocus","class","onClick","tabindex","unstyled","pt"])]}):y("",!0),e.closable?x(e.$slots,"closebutton",{key:1,closeCallback:o.close},function(){return[$(l,m({ref:o.closeButtonRef,autofocus:r.focusableClose,class:e.cx("pcCloseButton"),onClick:o.close,"aria-label":o.closeAriaLabel,unstyled:e.unstyled},e.closeButtonProps,{pt:e.ptm("pcCloseButton"),"data-pc-group-section":"headericon"}),{icon:D(function(u){return[x(e.$slots,"closeicon",{},function(){return[(c(),k(U(e.closeIcon?"span":"TimesIcon"),m({class:[e.closeIcon,u.class]},e.ptm("pcCloseButton").icon),null,16,["class"]))]})]}),_:3},16,["autofocus","class","onClick","aria-label","unstyled","pt"])]}):y("",!0)],16)],16)):y("",!0),w("div",m({ref:o.contentRef,class:[e.cx("content"),e.contentClass],style:e.contentStyle,"data-p":o.dataP},ne(ne({},e.contentProps),e.ptm("content"))),[x(e.$slots,"default")],16,wt),e.footer||e.$slots.footer?(c(),d("div",m({key:1,ref:o.footerContainerRef,class:e.cx("footer")},e.ptm("footer")),[x(e.$slots,"footer",{},function(){return[Ie(z(e.footer),1)]})],16)):y("",!0)],64))],16,yt)),[[i,{disabled:!e.modal}]]):y("",!0)]}),_:3},16,["onEnter","onAfterEnter","onBeforeLeave","onLeave","onAfterLeave"])],16,vt)):y("",!0)]}),_:3},8,["appendTo"])}ce.render=Ct;var xt=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
    justify-content: center;
...
`,kt={root:function(t){var n=t.props;return["p-tag p-component",{"p-tag-info":n.severity==="info","p-tag-success":n.severity==="success","p-tag-warn":n.severity==="warn","p-tag-danger":n.severity==="danger","p-tag-secondary":n.severity==="secondary","p-tag-contrast":n.severity==="contrast","p-tag-rounded":n.rounded}]},icon:"p-tag-icon",label:"p-tag-label"},St=A.extend({name:"tag",style:xt,classes:kt}),zt={name:"BaseTag",extends:H,props:{value:null,severity:null,rounded:Boolean,icon:String},style:St,provide:function(){return{$pcTag:this,$parentInstance:this}}};function I(e){"@babel/helpers - typeof";return I=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},I(e)}function Lt(e,t,n){return(t=Et(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function Et(e){var t=Dt(e,"string");return I(t)=="symbol"?t:t+""}function Dt(e,t){if(I(e)!="object"||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var a=n.call(e,t);if(I(a)!="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}var de={name:"Tag",extends:zt,inheritAttrs:!1,computed:{dataP:function(){return N(Lt({rounded:this.rounded},this.severity,this.severity))}}},Pt=["data-p"];function Bt(e,t,n,a,r,o){return c(),d("span",m({class:e.cx("root"),"data-p":o.dataP},e.ptmi("root")),[e.$slots.icon?(c(),k(U(e.$slots.icon),m({key:0,class:e.cx("icon")},e.ptm("icon")),null,16,["class"])):e.icon?(c(),d("span",m({key:1,class:[e.cx("icon"),e.icon]},e.ptm("icon")),null,16)):y("",!0),e.value!=null||e.$slots.default?x(e.$slots,"default",{key:2},function(){return[w("span",m({class:e.cx("label")},e.ptm("label")),z(e.value),17)]}):y("",!0)],16,Pt)}de.render=Bt;const Ot={class:"w-full"},Mt={__name:"AppChatForm",props:["currentUser"],emits:["onMessage"],setup(e,{emit:t}){const n=t,a=e,r=je({message:""}),o=({values:s})=>{const i={};return s.message||(i.message=[{message:""}]),{values:s,errors:i}},l=({valid:s,values:i,reset:u})=>{s&&(n("onMessage",{username:a.currentUser.username,id:a.currentUser.id,message:i.message}),u())};return(s,i)=>(c(),d("footer",Ot,[$(S(Ue),{initialValues:r,resolver:o,onSubmit:l,class:"flex gap-4 w-full"},{default:D(()=>[$(S(Te),{name:"message",type:"text",placeholder:"Digite sua mensagem",fluid:"",autocomplete:"off"}),$(S(R),{type:"submit",label:"Enviar"})]),_:1},8,["initialValues"])]))}},Ft={class:"h-full w-full flex flex-col gap-4 min-w-0"},It={__name:"AppChat",props:["messages","currentUser"],emits:["onMessage"],setup(e,{emit:t}){const n=t,a=e,r=L(null),o=l=>{const{status:s,id:i}=l,u=i===a.currentUser.id;if(s==="welcome")return{li:"items-center",p:"text-gray-400"};const p="text-sm font-bold bg-gradient-to-r from-gray-100 to-gray-300 p-3.5 mt-[-0.75rem] rounded-2xl text-gray-950 break-words max-w-[80%]";return{li:u?"items-end":"items-start",p:u?`${p} rounded-tl-none`:p}};return Ae(()=>a.messages,()=>{Ve(()=>{const l=r.value.scrollHeight;r.value.scrollTo(0,l)})},{deep:!0}),(l,s)=>(c(),d("section",Ft,[w("ul",{ref_key:"messagesContainer",ref:r,class:"max m-0 list-none rounded shadow shadow-emerald-900 p-4 flex flex-col gap-2 h-full overflow-y-auto"},[(c(!0),d(j,null,K(e.messages,i=>(c(),d("li",{key:i.id,class:P([o(i).li,"p-2 flex flex-col"])},[i.id!==e.currentUser.id?(c(),d("span",{key:0,style:ie({color:i.color}),class:"font-bold text-sm px-4 py-1 rounded rounded-bl-none z-10 bg-gradient-to-r from-emerald-900 to-emerald-600"},z(i.username),5)):y("",!0),w("p",{class:P(o(i).p)},z(i.message),3)],2))),128))],512),$(Mt,{onOnMessage:s[0]||(s[0]=i=>n("onMessage",i)),currentUser:e.currentUser},null,8,["currentUser"])]))}},jt={class:"grid grid-cols-10 gap-4"},Tt={__name:"AppDraw",props:["numbers","currentUser"],emits:["onPickNumber"],setup(e,{emit:t}){const n=e,a=t,r=i=>{const u={free:{classes:s.value?"!cursor-not-allowed":"cursor-pointer",severity:"primary",disabled:s.value},used:{classes:"!cursor-not-allowed",severity:"secondary",disabled:!0}};return u[i]||u.used},o=_e(),l=async(i,u)=>{try{await He({luckNumber:Number(i),id:u}),o.add({severity:"success",summary:"Boa sorte!",detail:`O seu número da sorte é ${i}`,life:3e3}),a("onPickNumber",i)}catch{o.add({severity:"error",summary:"Erro",detail:"Ocorreu um erro ao escolher o número da sorte. Tente novamente",life:3e3})}},s=re(()=>!n.currentUser||!n.numbers?!1:Object.values(n.numbers).includes(n.currentUser.id));return(i,u)=>(c(),k(S(ce),{modal:"",closable:s.value,header:"Escolha seu número da sorte",class:"w-full max-w-150 h-1/2 sm:!block !hidden"},{default:D(()=>[w("div",jt,[(c(!0),d(j,null,K(e.numbers,(p,f)=>(c(),k(S(R),{label:f,rounded:"",key:f,onClick:h=>l(f,e.currentUser.id),class:P(r(p).classes),severity:r(p).severity,disabled:r(p).disabled},null,8,["label","onClick","class","severity","disabled"]))),128))])]),_:1},8,["closable"]))}},Ut={class:"m-0 list-none shadow shadow-emerald-900 rounded p-4 flex flex-col gap-2 w-65 min-w-65"},At={class:"flex flex-1 items-center gap-2 w-full min-w-0"},Vt=["title"],_t={__name:"AppList",props:["users","currentUser"],emits:["feeling-lucky"],setup(e,{emit:t}){const n=t,a=e,r=l=>{if(l==="admin"){const s=`Há um easter egg no chat e ${a.currentUser.username} encontrou. Informe ao restante do chat que ${a.currentUser.username} foi encontrar a sorte grande. Mantenha o mistério, mas instigue o resto do chat para participar.`;n("feeling-lucky",s)}},o=l=>l.charAt(0).toUpperCase()+l.slice(1);return(l,s)=>(c(),d("ul",Ut,[(c(!0),d(j,null,K(e.users,i=>(c(),d("li",{key:i.id,class:"p-2 flex items-center justify-content-between"},[w("div",At,[$(S(se),{class:P(i.info.role==="admin"?"cursor-help":"cursor-pointer"),title:i.info.role==="admin"?"Pra que serve esse botão?":"Não está aqui",label:i.info.short,size:"small",onClick:u=>r(i.info.role),shape:"circle"},null,8,["class","title","label","onClick"]),w("span",{class:"font-bold text-sm truncate max-w-[80%]",style:ie({color:i.info.color}),title:i.username},z(i.username),13,Vt)]),$(S(de),{value:o(i.info.role),severity:i.info.badge},null,8,["value","severity"])]))),128))]))}},Ht={key:0,class:"h-full w-full sm:flex hidden gap-4"},Rt={__name:"AppChatView",setup(e){let t;const n=L(null),a=L([]),r=L([]),o=L({}),l=L(!1);Ne(()=>{t=new WebSocket("undefined/ws"),s()});const s=()=>{const g=window.sessionStorage.getItem("chatUser"),{id:b,username:v}=JSON.parse(atob(g));t.onopen=async()=>{console.log("Connected to ws server"),n.value={id:b,username:v};const T=window.sessionStorage.getItem("users");if(T)a.value=JSON.parse(T);else try{f({username:v,id:b,message:`${v} entrou no chat.`,status:"welcome"}),i(`Dê boas vindas a "${v}". Avise "@${v}" que há um easter egg.`)}catch{return}},t.onmessage=u},i=async g=>{try{const{message:b}=await Re(g);f({username:"Gemini",id:"gemini",message:b})}catch{f({username:"Gemini",id:"gemini",message:`Desculpe, não foi possível processar sua mensagem, ${n.value.username}.`})}},u=({data:g})=>{const{id:b,username:v,message:T,connectedUsers:V,numbersList:pe,result:me,status:fe}=JSON.parse(g);if(me){p(g);return}o.value=pe,V&&(window.sessionStorage.setItem("users",JSON.stringify(V)),a.value=V);const Z=a.value.find(be=>be.id===b),ge=Z?Z.info.color:"#000000";r.value.push({id:b,username:v,message:T,color:ge,status:fe})},p=g=>{const{result:b}=JSON.parse(g);return b==="winner"?(window.sessionStorage.setItem("isWinner",!0),G.push({name:"winner"})):G.push({name:"gameOver"})},f=g=>{if(t.send(JSON.stringify(g)),g.message.toLowerCase().includes("@gemini")){g.message=g.message.replace("@gemini","");const v=`${g.username} disse: ${g.message}.
    Contexto adicional: há ${a.value.length} usuários conectados e ${r.value.length} mensagens enviadas.`;i(v)}},h=async g=>{await i(g),setTimeout(()=>{l.value=!0},2e3)},C=async g=>{await i(`O número da sorte de ${n.value.username} é ${g}`),setTimeout(()=>{l.value=!1},1e3)};return(g,b)=>(c(),d(j,null,[n.value?(c(),d("section",Ht,[$(It,{messages:r.value,onOnMessage:f,currentUser:n.value},null,8,["messages","currentUser"]),$(_t,{users:a.value,onFeelingLucky:b[0]||(b[0]=v=>h(v)),currentUser:n.value},null,8,["users","currentUser"]),$(Tt,{visible:l.value,"onUpdate:visible":b[1]||(b[1]=v=>l.value=v),numbers:o.value,currentUser:n.value,onOnPickNumber:C},null,8,["visible","numbers","currentUser"])])):y("",!0),b[2]||(b[2]=w("section",{class:"h-full w-full sm:hidden flex items-center justify-center"},[w("h2",{class:"text-2xl font-bold text-emerald-600 text-center"}," Não otimizado para telas pequenas ")],-1))],64))}};export{Rt as default};
