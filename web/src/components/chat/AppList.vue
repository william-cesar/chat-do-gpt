...
const feelingLucky = (role) => {
  if (role === 'admin') {
    const prompt = `O usuário ${props.currentUser.username} encontrou o easter egg. Informe ao restante do chat que ${props.currentUser.username} foi encontrar a sorte grande. Mantenha o mistério, mas instigue o resto do chat para participar.`
